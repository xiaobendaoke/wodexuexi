...
class OffloadDatasetRecorder:
    ...
    def record(self, context: ServiceOffloadContext, heuristic_label: int, scenario_name: str | None = None) -> None:
        ...
        self.features.append(context_to_feature_vector(context))
    ...
    def export(self) -> dict[str, np.ndarray]:
        feature_dim = len(get_offload_feature_specs())
...
def collect_multi_scenario_dataset(
    *,
    ...
    metadata: dict[str, object] = {
        ...
        "scenario_attempt_counts": attempt_counts,
        "scenario_accepted_counts": accepted_counts,
        "scenario_descriptions": {spec.name: spec.description for spec, _ in scenario_entries},
        "notes": (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mode", type=str, default="random_rollout", choices=["random_rollout", "scenario_mixed"], help="Collection mode.")

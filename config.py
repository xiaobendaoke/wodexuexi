...
MODEL: str = "attention_mappo"  # options: "attention_mappo", "vanilla_mappo", "joint_mappo", "uncoordinated_greedy"
...
OFFLOAD_REWARD_LATENCY_WEIGHT: float = 4.0
OFFLOAD_REWARD_ENERGY_WEIGHT: float = 1.2
